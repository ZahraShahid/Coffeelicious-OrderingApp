...
public class BubbleActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addtoCart.setOnClickListener(v -> {
            Intent intent = new Intent(BubbleActivity.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(v -> {
            ...
            if (quantity == 0) {
                Toast.makeText(BubbleActivity.this, "Cant decrease quantity < 0", Toast.LENGTH_SHORT).show();
            } else {
                quantity--;
                displayQuantity();
                int coffePrice = basePrice * quantity;
