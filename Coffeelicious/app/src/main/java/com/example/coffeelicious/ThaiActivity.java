...
public class ThaiActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addtoCart.setOnClickListener(v -> {
            Intent intent = new Intent(ThaiActivity.this, SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(v -> {
            ...
            if (quantity == 0) {
                Toast.makeText(ThaiActivity.this, "Cant decrease quantity < 0", Toast.LENGTH_SHORT).show();
            } else {
                quantity--;
                displayQuantity();
                int coffePrice = basePrice * quantity;
